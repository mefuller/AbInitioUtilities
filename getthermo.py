...
# input files
IN_FormCHK = "CH3COCH3.fchk" # Name of  gaussian 09 formatted checkpoint file
thermo       = load_molecule_g03fchk(IN_FormCHK)

thermo_scan1 = load_rotscan_g03log("r_CH3COCH3_rotCH3_1.log")
thermo_scan2 = load_rotscan_g03log("r_CH3COCH3_rotCH3_1.log")
...
# rotor objects
rotor1  = Rotor(thermo_scan1, thermo, rotsym=3, cancel_freq='scan', even=False, dofmax=3, num_levels = levels)
rotor2  = Rotor(thermo_scan2, thermo, rotsym=3, cancel_freq='scan', even=False, dofmax=3, num_levels = levels)
...
for i in xrange(len(enthalpy)):
  print "{:>10.2f} {:>10.3f} {:>10.3f} {:>10.3f} {:>10.3f} {:>10.1f} {:>10.1f} {:>10.2f} {:>10.2f}".format(enthalpy[i,0],enthalpy[i,1],enthalpy[i,2],enthalpy[i,3],enthalpy[i,4],enthalpy[i,5],enthalpy[i,6],enthalpy[i,8],enthalpy[i,7])
...
for i in xrange(len(enthalpy)):
  print "{:>10.2f} {:>10.3f} {:>10.3f} {:>10.3f} {:>10.3f} {:>10.1f} {:>10.1f} {:>10.2f} {:>10.2f}".format(enthalpy[i,0],enthalpy[i,1],enthalpy[i,2],enthalpy[i,3]/kcal,enthalpy[i,4]/kcal,enthalpy[i,5]/kcal,enthalpy[i,6]/kcal,enthalpy[i,8]/kcal,enthalpy[i,7]/kcal)
...
numpy.savetxt("dat/nasa_coefficients.csv",numpy.reshape(coeffs,(1,len(coeffs))),delimiter=',',header=head)
...
moleculeSmile = readstring("cml",readfile("fchk", IN_FormCHK).next().write("cml")).write("smi").split()[0]  #  with transfer fchk to cml and read cml multplicity is assigned "smi" prints SMILES and title
...
print "{:19}{:>5}{:1}{:4}{:1}{:4}{:1}{:4}{:1}{:4}{:4}{:<9.3f}{:<9.3f}{:<9.3f}{:>5}".format( \
     identName, instNameDate, C, carb, H, hydro, O, oxy, other, oth, "G", min(T), max(T), 1000, str(IntRots) + "1")
